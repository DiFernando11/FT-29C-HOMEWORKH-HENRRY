...
const { incremento, decremento, incrementoInpar, incrementoAsync } = require('./actions');
...
document.getElementById("incrementoImpar").onclick = () => store.dispatch(incrementoInpar());
